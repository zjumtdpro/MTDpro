# Microhomology Arm Analysis in the Human Genome
library(ggplot2)
library(ggnewscale)
library(tidyr)
...
library(cowplot)
# load data
raw_data <-  openxlsx::read.xlsx("mtd-figure3-2.xlsx", sheet = 2, colNames = FALSE)
...
p_annotated
ggsave(p_annotated,filename = 'Figure3-2/ref.png',width = 10,height = 8.5)
